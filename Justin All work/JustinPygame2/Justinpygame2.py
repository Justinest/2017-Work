...
pygame.draw.line(screen, BLACK, [0, 0], [100, 100], 20) 
for y_offset in range(0, 100, 10):
    pygame.draw.line(screen,BLACK,[0,10+y_offset],[100,110+y_offset],5)
    for i in range(200):
        ...
        for x_offset in range(30, 300, 30):
            ...
            pygame.draw.rect(screen,BLACK,[20,20,250,100],20)
